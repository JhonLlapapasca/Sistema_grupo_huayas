...
<body>
    <div class="container mt-5 mx-auto">
        ...
        <div class="mt-5">
            <h4 class="noImprimir">Venta - Factura</h4>
            <div class="row">
                <div class="col-3">
                        ...
                        <div class="card-body">
                            <div>
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                    ...
                                    $nombre_comercial = isset($_POST['nombre_comercial']) ? htmlspecialchars($_POST['nombre_comercial'], ENT_QUOTES, 'UTF-8') : '';
                                    $domicilio_fiscal = isset($_POST['domicilio_fiscal']) ? htmlspecialchars($_POST['domicilio_fiscal'], ENT_QUOTES, 'UTF-8') : '';

                                    echo "<p>Razón Social: $nombre_comercial</p>";
                                    echo "<p>RUC: $ruc</p>";
                                    echo "<p>Domicilio Fiscal: $domicilio_fiscal</p>";
                                }
                                ?>
                            </div>
                            <div>
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                echo '<p id="total" class="fs-5 fw-bold"></p>';

                                // Mostrar total acumulado
                                // $subtotalventa = $totalPrice;
                                // $igv = $subtotalventa * 0.18;
                                // $total = $subtotalventa + $igv;

                                // echo '<p>SubTotal: S/. ' . htmlspecialchars($subtotalventa, ENT_QUOTES, 'UTF-8') . '</p>';
                                // echo '<p>I.G.V.(18%): S/. ' . htmlspecialchars($igv, ENT_QUOTES, 'UTF-8') . '</p>';
                                // echo '<p>Total: S/. ' . htmlspecialchars($total, ENT_QUOTES, 'UTF-8') . '</p>';
                            }
                            ?>
                        </div>
                    </div>
...
<script>
    function updateTotal() {
        ...
        document.getElementById('total_price').innerText = 'SubTotal: S/. ' + subtotal.toFixed(2) + '\nI.G.V.(18%): S/. ' + igv.toFixed(2);
        document.getElementById('total').innerText = 'Total: S/. ' + total.toFixed(2);
        document.getElementById('yapear').innerText = 'S/. ' + total.toFixed(2);
